...
var ASM_CONSTS = {
  88918: () => { if (document.fullscreenElement) return 1; },  
 88964: () => { return Module.canvas.width; },  
 88996: () => { return parseInt(Module.canvas.style.width); },  
 89044: () => { document.exitFullscreen(); },  
 89071: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 89143: () => { if (document.fullscreenElement) return 1; },  
 89189: () => { return Module.canvas.width; },  
 89221: () => { return screen.width; },  
 89246: () => { document.exitFullscreen(); },  
 89273: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89467: () => { return window.innerWidth; },  
 89493: () => { return window.innerHeight; },  
 89520: () => { if (document.fullscreenElement) return 1; },  
 89566: () => { return Module.canvas.width; },  
 89598: () => { return parseInt(Module.canvas.style.width); },  
 89646: () => { if (document.fullscreenElement) return 1; },  
 89692: () => { return Module.canvas.width; },  
 89724: () => { return screen.width; },  
 89749: () => { return window.innerWidth; },  
 89775: () => { return window.innerHeight; },  
 89802: () => { if (document.fullscreenElement) return 1; },  
 89848: () => { return Module.canvas.width; },  
 89880: () => { return screen.width; },  
 89905: () => { document.exitFullscreen(); },  
 89932: () => { if (document.fullscreenElement) return 1; },  
 89978: () => { return Module.canvas.width; },  
 90010: () => { return parseInt(Module.canvas.style.width); },  
 90058: () => { document.exitFullscreen(); },  
 90085: ($0) => { Module.canvas.style.opacity = $0; },  
 90123: () => { return screen.width; },  
 90148: () => { return screen.height; },  
 90174: () => { return window.screenX; },  
 90201: () => { return window.screenY; },  
 90228: () => { return window.devicePixelRatio; },  
 90264: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90317: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90368: () => { Module.canvas.style.cursor = 'none'; },  
 90405: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90661: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90712: () => { if (document.pointerLockElement) return 1; },  
 90759: () => { if (document.fullscreenElement) return 1; },  
 90805: () => { return window.innerWidth; },  
 90831: () => { return window.innerHeight; }
};
